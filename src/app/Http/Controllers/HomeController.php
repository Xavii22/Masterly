...
class HomeController extends Controller
{
    public function home(Request $request)
    {
        ...
        return view('pages.home', compact('products', 'productAmount', 'query', 'category', 'parentCategories', 'sort'));
        //return view('pages.home', compact('products', 'productAmount', 'parentCategories', 'query', 'sort', 'category', 'subCategory'));
    }
