...
@section('content')
    <div class="form-login-register">
        ...
        <input
                ...
                type="text" id="email" placeholder="Correo electrónico" required autofocus
                value="{{ old('email') }}">
            @if ($errors->has('email'))
        ...
        <a href="{{ route('pages.login') }}"><input class="button-login-register button button--blue" type="submit" value="Register!"></a>
